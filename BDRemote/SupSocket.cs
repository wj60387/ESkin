...
namespace BDAuscultation.Commucation
{
    ...
    public class SupSocket
    {
        ...
        public void OpenSocket(string RemoteID = "" )
        {
            var remoteID = new KeyValuePair<string, string>("RemoteID", RemoteID);
            webSocket = new WebSocket(serverPath, new List<KeyValuePair<string, string>>() { remoteID });
